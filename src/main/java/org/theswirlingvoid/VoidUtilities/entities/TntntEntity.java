...
import org.theswirlingvoid.VoidUtilities.explosions.Explosionnt;
...
public class TntntEntity extends Entity {
   private static final DataParameter<Integer> FUSE = EntityDataManager.createKey(TntntEntity.class, DataSerializers.VARINT);
   @Nullable
   private LivingEntity tntPlacedBy;
   private int fuse = 80;

   public TntntEntity(EntityType<? extends TntntEntity> p_i50216_1_, World p_i50216_2_) {
      super(p_i50216_1_, p_i50216_2_);
      this.preventEntitySpawning = true;
   }

   public TntntEntity(World worldIn, double x, double y, double z, @Nullable LivingEntity igniter) {
      this(ModEntities.TNTNT, worldIn);
   ...
   private void explode() {
      float f = 4.0F;
      this.createExplosion(this, this.posX, this.posY + (double)(this.getHeight() / 16.0F), this.posZ, 4.0F, Explosion.Mode.BREAK);
   }
   ...
   public Explosion createExplosion(@Nullable Entity p_217401_1_, @Nullable DamageSource p_217401_2_, double p_217401_3_, double p_217401_5_, double p_217401_7_, float p_217401_9_, boolean p_217401_10_, Explosion.Mode p_217401_11_) {
	      Explosion explosion = new Explosionnt(this.world, p_217401_1_, p_217401_3_, p_217401_5_, p_217401_7_, p_217401_9_, p_217401_10_, p_217401_11_);
	      if (p_217401_2_ != null) {
   ...
   public TntntEntity(FMLPlayMessages.SpawnEntity packet, World worldIn)
   {
       super(ModEntities.TNTNT, worldIn);
   }
   /**
