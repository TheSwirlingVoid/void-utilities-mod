...
public abstract class AbstractFurnacentTileEntity extends LockableTileEntity implements ISidedInventory, IRecipeHolder, IRecipeHelperPopulator, ITickableTileEntity {
   ...
   protected final IIntArray furnaceData = new IIntArray() {
      public int get(int index) {
         switch(index) {
         case 0:
            return AbstractFurnacentTileEntity.this.burnTime;
         case 1:
            return AbstractFurnacentTileEntity.this.recipesUsed;
         case 2:
            return AbstractFurnacentTileEntity.this.cookTime;
         case 3:
            return AbstractFurnacentTileEntity.this.cookTimeTotal;
         default:
            return 0;
         }
      }
      ...
      public void set(int index, int value) {
         switch(index) {
         case 0:
            AbstractFurnacentTileEntity.this.burnTime = value;
            break;
         case 1:
            AbstractFurnacentTileEntity.this.recipesUsed = value;
            break;
         case 2:
            AbstractFurnacentTileEntity.this.cookTime = value;
            break;
         case 3:
            AbstractFurnacentTileEntity.this.cookTimeTotal = value;
         }
   ...
   protected AbstractFurnacentTileEntity(TileEntityType<?> tileTypeIn, IRecipeType<? extends AbstractCookingRecipe> recipeTypeIn) {
      super(tileTypeIn);
 ...
 break;
         ...
         if (flag != this.isBurning()) {
            flag1 = true;
            this.world.setBlockState(this.pos, this.world.getBlockState(this.pos).with(AbstractFurnacentBlock.LIT, Boolean.valueOf(this.isBurning())), 3);
         }
      }
