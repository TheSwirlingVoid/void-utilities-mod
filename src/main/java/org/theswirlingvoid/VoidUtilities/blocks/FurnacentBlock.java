...
public class FurnacentBlock extends AbstractFurnacentBlock {
   public FurnacentBlock(Block.Properties builder) {
      super(builder);
   }

   public TileEntity createNewTileEntity(IBlockReader worldIn) {
      return new FurnacentTileEntity();
   }
   ...
   protected void interactWith(World worldIn, BlockPos pos, PlayerEntity player) {
      ...
      if (tileentity instanceof FurnacentTileEntity) {
