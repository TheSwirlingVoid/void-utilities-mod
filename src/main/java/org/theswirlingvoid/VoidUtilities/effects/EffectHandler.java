...
public class EffectHandler {
	...
	public static final MyopiaEffect myopia = (MyopiaEffect) new MyopiaEffect(EffectType.HARMFUL, 0,0,0).setRegistryName("myopia").addAttributesModifier(SharedMonsterAttributes.FOLLOW_RANGE, "7407DE5E-7CE8-4030-940E-514C1F160890", -0.5, AttributeModifier.Operation.MULTIPLY_BASE);
